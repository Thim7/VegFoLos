...
function Checkout() {
    ...
    return (
        <>
            <Header isCheckout />
            <div className="mt-24 bg-light-background dark:bg-dark-background">
                <div className="flex-col space-y-8 pt-20 pb-64 w-[428px] m-auto">
                    <div>
                        <Typography className="text-4xl font-normal text-light-on-surface">
                            Last Step - Checkout
                        </Typography>
                    ...
                    <div className="w-full flex-col space-y-4 bg-light-surface-container-lowest rounded-lg divide-y divide-light-outline-variant p-4">
                        ...
                        <div className="flex-col pt-4">
                            ...
                            <Typography className="text-base font-semibold text-light-on-surface">
                                {order[order?.length - 1]?.timeDelivery} mins (
                                {order[order?.length - 1]?.distanceDelivery} km away)
                            </Typography>
                        </div>
                                                        ...
                                                        <Dialog open className="bg-light-surface-container-lowest">
                                                            ...
                                                            {order.length === 1 && (
                                                                <DialogBody className="text-light-on-surface-variant ">
                                                                    This is the only product in your order. Clicking
                                                                    "Yes" will cancel the order and return you to the
                        ...
                        <div className="pt-4">
                            ...
                            >
                                ...
                                <Option value="credit" className="w-full inline-flex items-center space-x-1">
                                    <CreditCardIcon color="#414940" />{' '}
                                    <p className="text-light-on-surface ">Credit Card</p>
                                </Option>
                            </Select>
                        </div>
                    </div>
                        ...
                        <div className="flex-col pt-4 space-y-7">
                            ...
                            <div className=" w-full h-fit p-1 border border-light-outline rounded-lg">
                                <div className="w-full inline-flex items-end justify-between">
                                    ...
                                    <Button className="bg-light-primary text-light-on-primary rounded-full ">
                                        Apply
                                    </Button>
                                </div>
                            </div>
                    ...
                    <div className="w-full inline-flex items-center space-x-5 justify-center">
                        <Typography className="font-normal text-xs text-light-on-background">
                            © 2023 VegFoLos
                        </Typography>
