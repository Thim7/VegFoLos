...
function Searchbar() {
    return (
        <div className="shrink-0 flex justify-between items-center max-w-xl w-full h-14 bg-light-surface-container-lowest border rounded-full border-black border-solid px-4 space-x-5 focus-within:border-light-secondary-container transition">
